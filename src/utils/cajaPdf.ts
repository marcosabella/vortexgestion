...
const drawHeader = (
  ...
  const reportTitle = options.reportTitle || "LISTADO DE CAJA";
  const reportTitleFontSize = reportTitle.length > 24 ? 11.5 : 14.5;
  ...
  return [
    ...
    opText(reportTitle, 363, 56, reportTitleFontSize, "F2", "left", 206),
