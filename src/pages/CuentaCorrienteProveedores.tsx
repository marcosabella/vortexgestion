...
export default function CuentaCorrienteProveedores() {
  ...
  const { movimientos, isLoading, error } = useCompras({ cargarCompras: false, cargarFacturas: false });
  ...
  const summaries = useMemo(() => {
    ...
    movimientos.forEach((movement) => {
      ...
      if (movement.tipo === "deuda" && movement.gasto) row.expenses += Number(movement.monto);
